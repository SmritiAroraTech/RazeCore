...
extension RazeCore {
    public class Color {
        ...
        internal class func fromHexString(hexString: String, alpha: CGFloat = 1.0) -> UIColor {
            let r,g,b: CGFloat
